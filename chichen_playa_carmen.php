...
if($_SESSION['lang']=='en') {
  $titulo="Chichen Itza | Arriving at Playa del Carmen or Riviera Maya";
}else{
  ...
  <div class="container">
    <div class="row">
      <div id="titulo-interiores">
        <h1><?php if($_SESSION['lang']=='en'){echo'Chichen Itza';}else{echo'Chichen Itzá';} ?> <span class="linea-interior">|</span> <span class="subinteriores"><?php if($_SESSION['lang']=='en'){echo'Arriving at Playa del Carmen or Riviera Maya';}else{echo'Con llegada a Playa del Carmen o Riviera Maya';} ?></span></h1>
      </div>
    </div>
  </div>
</section>
