...
if($_SESSION['lang']=='en') {
  $titulo="Chichen Itzá | Arriving at Playa del Carmen or Riviera Maya";
}else{
...
<section class="visible-xs">
  <img src="images/banner_interiores360px/chichen-playa-carmen.jpg" class="banner-interiores">
</section>
  ...
  <div class="container">
    <div class="row">
      <div id="titulo-interiores">
        <h1><?php if($_SESSION['lang']=='en'){echo'Chichen Itzá';}else{echo'Chichen Itzá';} ?> <span class="linea-interior">|</span> <span class="subinteriores"><?php if($_SESSION['lang']=='en'){echo'Arriving at Playa del Carmen or Riviera Maya';}else{echo'Con llegada a Playa del Carmen o Riviera Maya';} ?></span></h1>
      </div>
    </div>
  </div>
</section>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
          ...
          <div>
            ...
            <div id="bg-video-sin-camioneta">
              ...
              {
                ?>
                <h1>Departures: <span>9:00 a.m. - 7:30 p.m.</span></h1>
                <?php
              }else{
                ?>
