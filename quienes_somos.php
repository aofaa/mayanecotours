...
<section class="fondo-quienes-somos visible-xs visible-sm">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-10 col-sm-offset-1">
        <div id="quienes-somos">
          ...
          if($_SESSION['lang']== 'en') {
            ...
            <h1>VIAJAR PUEDE CAMBIAR NUESTRA MENTE</h1>
            <p>
...
<section class="hidden-xs hidden-sm">
  ...
  <img src="images/banner_quienes_somos.jpg" class="img-maxwidth">
</section>
