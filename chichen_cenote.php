...
<section class="hidden-xs">
  ...
  <img src="images/banner_interiores/chichen-itza.jpg" class="banner-interiores">
</section>

<section class="visible-xs">
  <img src="images/banner_interiores360px/chichen-itza.jpg" class="banner-interiores">
</section>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
          ...
          if($_SESSION['lang']=='en')
          {
            ...
            <div id="caracteristicas">
              ...
              <p>
                No matter what level of experience you have in outdoor activities, you can do this fun challenge with the assistance of our guides that will accompany and advise you all the way, giving you a safe and memorable experience that will last for years to come.
              </p>
              <br>
              <p>
                <span>Included:</span><br>
              <ul class="listas">
                <li>Departure from your hotel at 9:00 h</li>
                <li>Transportation with A/C </li>
                <li>Certified guide that goes with you to the archaeological site</li>
                <li>Visit an impressive cenote </li>
                <li>Option to do rappel and zip line</li>
                <li>Snorkel equipment and life jacket</li>
                <li>Lunch</li>
                <li>Entrance fee to the cenote</li>
                <li>Return to your hotel at 17:00 h</li>
              </ul>
              </p>
              <p>
            ...
            <div id="caracteristicas">
              ...
              <p>
                Chichen Itzá es una de las zonas arqueológicas más grandes y ricas en monumentos de la República Mexicana.  Desde 1988 es Patrimonio de la Humanidad y hoy se levanta orgullosa por ser designada como una de las Siete Maravillas del Mundo Moderno.
              </p>
              <p>
                Después de visitar la zona arqueológica de Chichén Itzá, te llevamos a un cenote de tipo abierto en donde tendrás la oportunidad de hacer rappel, tirolesa, esnórquel o simplemente conocerlo y tirarte en una hamaca después de una rica comida tradicional del sureste mexicano.
              </p>
              <p>
                No importa el nivel de experiencia que tengas en actividades al aire libre, pero si te gustan los retos y las actividades extremas, ¡puedes hacerlo!, ponte un reto y véncelo con la asistencia de nuestros guías especializados que te acompañarán y asesorarán haciendo del reto toda una experiencia para recordar.
              </p>
              <br>
              <p>
              ...
              <ul class="listas">
                ...
                <li>Visita a un impresionante cenote</li>
                <li>Equipo de esnórquel</li>
                <li>Opción de hacer rappel o tirolesa</li>
                <li>Comida</li>
                <li>Entrada al Cenote</li>
                <li>Regreso a tu hotel  a las 5:00 p.m.</li>
              </ul>
              </p>
              <p>
