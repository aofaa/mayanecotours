...
if($_SESSION['lang']=='en') {
  $titulo="Chichen Itzá | With arrival to Cancun";
}else{
  ...
  <div class="container">
    <div class="row">
      <div id="titulo-interiores">
        <h1><?php if($_SESSION['lang']=='en'){echo'Chichen Itzá';}else{echo'Chichen Itzá';} ?> <span class="linea-interior">|</span> <span class="subinteriores"><?php if($_SESSION['lang']=='en'){echo'With arrival to Cancun';}else{echo'Con llegada a Cancún';} ?></span></h1>
      </div>
    </div>
  </div>
</section>
