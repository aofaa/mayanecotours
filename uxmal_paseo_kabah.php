...
if($_SESSION['lang']=='en') {
  $titulo="Uxmal | With Kabah tour";
}else{
  $titulo="Uxmal | Con paseo en Kabáh";
}
...
<section class="hidden-xs">
    ...
    <img src="images/banner_interiores/uxmal_kabah.jpg" class="banner-interiores">
</section>

<section class="visible-xs">
  <img src="images/banner_interiores360px/uxmal_kabah.jpg" class="banner-interiores">
</section>
  ...
  <div class="container">
    <div class="row">
      <div id="titulo-interiores">
        <h1><?php if($_SESSION['lang']=='en'){echo'Uxmal';}else{echo'Uxmal';} ?> <span class="linea-interior">|</span> <span class="subinteriores"><?php if($_SESSION['lang']=='en'){echo'With Kabah tour';}else{echo'Con paseo en Kabáh';} ?></span></h1>
      </div>
    </div>
  </div>
</section>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
          ...
          <div>
            ...
            <div id="bg-video-sin-camioneta">
              ...
              <table>
                <tr>
                  <td><a href="https://www.youtube.com/watch?v=sOCtBenVytc" target="_blank"><img src="<?php echo $_SESSION['lang']=='en'?'images/eng/video.png':'images/video.png'; ?>" class="img-responsive btn-video"></a></td>
