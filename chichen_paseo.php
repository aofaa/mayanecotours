...
<section class="hidden-xs">
    ...
    <img src="images/banner_interiores/chichen-paseo.jpg" class="banner-interiores">
</section>

<section class="visible-xs">
  <img src="images/banner_interiores360px/chichen-paseo.jpg" class="banner-interiores">
</section>
  ...
  <div class="container">
    <div class="row">
      <div id="titulo-interiores">
        <h1>Chichen Itzá <span class="linea-interior">|</span> <span class="subinteriores">Paseo en zona arqueológica</span></h1>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
          ...
          <div>
            <img src="images/thumbnail_interiores/02_chichen.jpg" class="img-responsive img-foto-interior center-block">
            <div id="bg-video-sin-camioneta">
                <h1>Salidas: <span>de 9:00 a.m. a 5:30 p.m.</span></h1>
              <table>
                <tr>
